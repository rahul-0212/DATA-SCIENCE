...
# # # # print(name.count("a")) #ye btata h vo char. kitni baar aaya h us string me
...
# # # unique
# # # mutable
# # my_dict={"name":"Rahul","class":"2nd year","roll number":"23EMVCS010","address":"Pali"}    
# # # name, class , roll number , address >>>>>>>> keys
# # # Rahul , 2nd year , 23EMVCS010 , Pali etc. are values 
# # # name: Rahul is item
...
# # my_dict.update({'branch': 'CIVIL'}) # this will update the dictionary with new key-value pairs
# # print(my_dict)
# # # access using get function
# # print(my_dict.get("name")) # Rahul
# # print(my_dict.get("branch")) # CSE
# # print(my_dict.get("age")) # Key not found, returns default value
# # print(my_dict.get("address")) # Pali
# # print(my_dict.get("roll number")) # 23EMVCS010
...
# # # immutable
# # # unique
# # # myset={1,2,3,3,5,8,7,10,9,"Rahul",2.3}
